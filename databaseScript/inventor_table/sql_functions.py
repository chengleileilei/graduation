...
def writeIpcTopInventor(inventor_id, cursor):
    ...
    for first_word, score in ipc_score.items():
        ...
        table_data = json.loads(cursor.fetchone()[0])
        if len(table_data) < 10:
            ...
            if(score > table_data[min_score_key]):
                ...
                table_data[inventor_id]=score
        update_sql = "UPDATE ipc_top_inventor SET top_inventors='"+ json.dumps(table_data, ensure_ascii=False)+"' WHERE ipc_category='"+first_word +"';"
